...
\todo{Definice podobnosti, používané metriky (textové, numerické, atd.)}
\todo{Praktické ukázky (Levenshteinova vzdálenost, Jaccard, kosinová podobnost)}
\todo{Výhody, nevýhody a omezení metody}
